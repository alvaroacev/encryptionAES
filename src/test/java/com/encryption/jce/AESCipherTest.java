...
import com.encryption.jce.KeystoreUtil;
...
public class AESCipherTest {
    ...
    public void encryptMessageFromKeystore() {
        ...
        Key key = KeystoreUtil.getKeyFromKeyStore("src/test/resources/aes-keystore.jck", "mystorepass", "jceksaes128Bits", "mykeypass");
